--> nova estrutura de calculo de saldo
--> corrigir as tabelas de excel
select rec.dt_mes_base,valor_recebido, valor_custo, saldo saldo_inicial, valor_recebido-valor_custo+if(saldo is null, 0, saldo) saldo, date_add(rec.dt_mes_base,interval 1 month) dt_mes_base_saldo from 
(
