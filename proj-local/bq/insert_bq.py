...
class InsertBq():
    ...
    def insert_df_credito(self, df, dataset, file_in):
        ...
        schema = [
            ...
            {'name': 'valor_credito_parc', 'type': 'FLOAT', 'mode': 'nullable'},
            {'name': 'dt_mes_base', 'type': 'DATE', 'mode': 'nullable'},
    ...
    def insert_df_listacompras(self, df, dataset, file_in):
        # Construct a BigQuery client object.
        client = bigquery.Client.from_service_account_json('resource/key.json')
        ...
        #'dt_mes_base','descricao','valor_recebido','dt_recebido'
        # na mesma posição que esta no dataframe
        # "item","codigo","descricao","tipo_unid","qtd","vl_unitario","vl_item","forma_pagamento","valor_total","data_compra"
        schema = [
            {'name': 'item', 'type': 'INT64', 'mode': 'nullable'},
            {'name': 'codigo', 'type': 'INT64', 'mode': 'nullable'},
            {'name': 'descricao', 'type': 'STRING', 'mode': 'nullable'},
            {'name': 'tipo_unid', 'type': 'STRING', 'mode': 'nullable'},
            {'name': 'qtd', 'type': 'FLOAT', 'mode': 'nullable'},
            {'name': 'vl_unitario', 'type': 'FLOAT', 'mode': 'nullable'} , 
            {'name': 'vl_item', 'type': 'FLOAT', 'mode': 'nullable'} ,
            {'name': 'forma_pagamento', 'type': 'STRING', 'mode': 'nullable'},
            {'name': 'valor_total', 'type': 'FLOAT', 'mode': 'nullable'} , 
            {'name': 'data_compra', 'type': 'DATETIME', 'mode': 'nullable'} ,
            {'name': 'mercado', 'type': 'STRING', 'mode': 'nullable'} ,
            {'name': 'dt_mes_base', 'type': 'DATE', 'mode': 'nullable'} ,
            {'name': 'process_time', 'type': 'TIMESTAMP', 'mode': 'nullable'} ,                          
            #{'name': 'valor_previsto', 'type': 'FLOAT', 'mode': 'nullable'}
            ]
        ...
        job_config = bigquery.LoadJobConfig(
            ...
            schema = [
                ...
                # data type is ambiguous.
        # "item","codigo","descricao","tipo_unid","qtd","vl_unitario","vl_item","forma_pagamento","valor_total","data_compra"                
            bigquery.SchemaField("item", bigquery.enums.SqlTypeNames.INT64),
            bigquery.SchemaField("codigo", bigquery.enums.SqlTypeNames.INT64),
            bigquery.SchemaField("descricao", bigquery.enums.SqlTypeNames.STRING),
            bigquery.SchemaField("tipo_unid", bigquery.enums.SqlTypeNames.STRING),
            bigquery.SchemaField("qtd", bigquery.enums.SqlTypeNames.FLOAT),
            #{'name': 'code', 'type': 'STRING', 'mode': 'nullable'},
            # Indexes are written if included in the schema by name.
            bigquery.SchemaField("vl_unitario", bigquery.enums.SqlTypeNames.FLOAT),      
            bigquery.SchemaField("vl_item", bigquery.enums.SqlTypeNames.FLOAT), 
            bigquery.SchemaField("forma_pagamento", bigquery.enums.SqlTypeNames.STRING),      
            bigquery.SchemaField("valor_total", bigquery.enums.SqlTypeNames.FLOAT) ,
            bigquery.SchemaField("data_compra", bigquery.enums.SqlTypeNames.DATETIME),  
            bigquery.SchemaField("mercado", bigquery.enums.SqlTypeNames.STRING),      
            bigquery.SchemaField("dt_mes_base", bigquery.enums.SqlTypeNames.DATE),
            bigquery.SchemaField("process_time", bigquery.enums.SqlTypeNames.TIMESTAMP)            
        ],
            # Optionally, set the write disposition. BigQuery appends loaded rows
